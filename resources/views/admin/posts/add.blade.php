            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-globe"></i>Add New Blog
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ url('/admin/posts/addpost') }}">
                            @if (count($errors) > 0)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea placeholder="Enter Content..." class="wysihtml5 form-control" rows="6" name="content" data-error-container="#editor1_error">{{ old('content') }}</textarea>
